...
<div style='margin:10px 0 14px 0;'><div style='font-weight:700;color:#153E75;margin-bottom:4px;'>근거성 평균 점수: 3.8/5</div><div style='height:14px;background:#EFF6FF;border-radius:8px;overflow:hidden;'><div style='width:76.0%;height:14px;background:#2563EB;'></div></div></div>
...
| TC-006 | 수료 기준 | 출석률은 95%인데 마지막 최종 프로젝트 점수가 과락이면 수료가 안 되나요? | 2 | 3 | 2 | 5 | False |
